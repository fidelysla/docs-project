# Programación Orientada a Objetos (POO) en Java - Parte 1
...
Un **Objeto** es una **instancia** de una clase. Mientras que la clase vive en el código fuente y el *metaspace* (definición), el objeto vive en la memoria **Heap** durante la ejecución.
